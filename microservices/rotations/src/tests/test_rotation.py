import pytest
import uuid
from app.models import Rotation, EnqueuedSinger
...
def fixture_singers():
    ...
    return [
        None,
        EnqueuedSinger(uuid.uuid4(), 'song 1'),
        EnqueuedSinger(uuid.uuid4(), 'song 2'),
        EnqueuedSinger(uuid.uuid4(), 'song 3'),
        EnqueuedSinger(uuid.uuid4(), 'song 4')
    ]
