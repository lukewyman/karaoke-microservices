...
def test_get_song_choices():
    ...
    choices = list(crud.get_song_choices(enqueued_singer_id=enqueued_singer_id))
...
def test_update_song_choices():
    ...
    crud.update_song_choices(choices=choices)

    updated_choices = list(crud.get_song_choices(enqueued_singer_id=enqueued_singer_id))
...
def test_update_choices_with_new_choice():
    ...
    crud.update_song_choices(choices)
