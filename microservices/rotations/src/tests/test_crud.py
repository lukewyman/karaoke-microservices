...
def test_update_singers():
    ...
    assert singers[0].singer_id == '69400125-d093-41c1-9415-6af0168078f4'
    singers[0].queue_position = 3
    assert singers[1].singer_id == '110974f0-9185-47c4-ae1b-f890048ea44d'
    singers[1].queue_position = 1
    assert singers[2].singer_id == 'cf298018-4c0b-4aa9-b8d4-15ea48996811'
    singers[2].queue_position = 2

    crud.update_singers(singers)
...
def test_update_singers_with_new_singer():
    ...
    new_singer = SingerDB(queue_id=queue_id,
